...
#源数据，带筛选的源数据
os_cleaned <- read.csv("D:/Desktop/医学/9-22/LUNG2/0-train_OS.csv", header = TRUE)  # 读取os_cleaned文件
...
# 将结果写入新的CSV文件
write.csv(final_data, file = "D:/Desktop/医学/9-22/LUNG2/2.1-enrichment_OS_out.csv", row.names = FALSE)
